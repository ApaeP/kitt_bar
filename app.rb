...
require_relative "#{__dir__}/config/initialize"

batches_serialized = File.read("#{__dir__}/data/batches.json")
...
require_relative "#{__dir__}/app/plugin"

App.run(CURRENT_BATCHES, OLD_BATCHES)
